...
## L∞
L Supremum atau yang dikenal dengan L norm tak terhingga yang dimana
adalah mencari nilai maksimum secara absolut antara setiap element vektor

Berikut contoh L Supremum :
![Contoh soal dengan L Supremum](images/LSup Example.png)
![Dengan menggunakan rumus L Supremum](images/LSup Formula.png)
![Contoh mencari L Supremum dari vektor A dengan Vektor C](images/LSup Answer.png)
...
![Cosine Similarity](images/Cosine2.png)

Penyelesaian :

![Cosine Similarity](images/Cosine3.png)
